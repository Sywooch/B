...
const REDIS_KEY_USER_FOLLOW_USER = 'user_follow_user:string';
...
#FOLLOW TAG
const REDIS_KEY_FOLLOW_TAG_ID_USER_ID = 'follow_tag_id_user_id:string';
...
return [
    ...
    #follow tag
    REDIS_KEY_FOLLOW_TAG_ID_USER_ID   => [
        'server'     => $servers['master'],
        'expire'     => 3600 * 2,
        'serializer' => Redis::SERIALIZER_IGBINARY,
    ],
