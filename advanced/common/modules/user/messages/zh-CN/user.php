...
$old_messages = [
    ...
    'Delete' => '',
    'Don\'t have an account? Sign up!' => '还没有账号？马上注册一个！',
    ...
    'Didn\'t receive confirmation message?' => '没有收到确认信息的邮件？',
    'Disconnect' => '断开连接',
    'Email' => '邮箱',
    'Email (public)' => '邮箱 (公共)',
...
return \yii\helpers\ArrayHelper::merge($old_messages,$new_messages);